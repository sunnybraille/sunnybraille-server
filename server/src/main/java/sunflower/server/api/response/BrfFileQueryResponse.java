...
public class BrfFileQueryResponse {
    ...
    @Schema(description = "Original File Name", defaultValue = "28번")
    ...
    public BrfFileQueryResponse(final Long id, final String originalFileName, final String content) {
        this.id = id;
        this.originalFileName = originalFileName;
        this.content = content;
    }

    public static BrfFileQueryResponse from(final Long id, final String originalFileName, final String brfContent) {
        return new BrfFileQueryResponse(id, originalFileName, brfContent);
    }
}
